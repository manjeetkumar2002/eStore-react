    ...
    <div className='row mt-4 mx-auto '>
        ...
        <div className='col-xl-2 col-sm-2 col'>
            ...
            <div className='d-flex gap-2'>
                <button onClick={setGridView} style={{backgroundColor:grid_view?"#0a4db8":"transparent",color:grid_view?"white":"black"}} className='px-2 py-1 border  fs-5 rounded-2'><i className="bi bi-grid-3x3-gap-fill"></i></button>
                <button onClick={setListView} style={{backgroundColor:!grid_view?"#0a4db8":"transparent",color:!grid_view?"white":"black"}} className='px-2 py-1 border  fs-5 rounded-2'><i className="bi bi-list-task"></i></button>
            </div>
        </div>
        {/* col5 */}
