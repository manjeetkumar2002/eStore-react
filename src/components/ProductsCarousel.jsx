  ...
  return (
    ...
    <div className="container-lg">
        <div className="row position-relative py-5 gap-4 overflow-hidden flex-nowrap">
            <div className="col text-center rounded-4" style={{ backgroundColor: 'var(--bs-secondary-bg)' }}>
                <img height="160px" src="./images/product-5.webp" alt="" />
                <h5 style={{ color: '#0a4db8' }} className="fs-6 mt-1">Aenean tellus</h5>
                <p className="text-secondary fs-6">8 Products</p>
            </div>
            <div className="col text-center rounded-4" style={{ backgroundColor: 'var(--bs-secondary-bg)' }}>
