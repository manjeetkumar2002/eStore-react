    ...
    <div id="header-section">
        <div className="container-lg overflow-hidden">
                <div className="row py-4 align-items-center">
                        ...
                        <div className="col-lg-4 col-8 fs-4">
                            <div className="icons float-end d-flex gap-3">
                                <i className="bi bi-search d-block d-lg-none"></i>
                                ...
                                <i className="bi bi-list d-block d-lg-none"></i>
                            </div>
                        </div>
                </div>
                <div className="row border border-start-0 border-end-0 py-3 d-lg-block d-none">
                    <ul id="nav-menu" className="list-unstyled d-flex fs-6 gap-3 mb-0 flex-wrap">
